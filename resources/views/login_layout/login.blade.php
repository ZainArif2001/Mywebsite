...
<body>
  <div class="container d-flex justify-content-center align-items-center ">
    <form class="shadow p-5 form glass-effect" action="{{ route('logins')}} " method="post" >
      @csrf
      ...
      <div class="col-6">
        ...
        <button type="submit" class="btn btn-primary mb-3 mt-5" >Sign In</button><br>
        <span class="span">You Dont Have Account Go <a href="{{route('register')}}">Sign Up</a>
        </span>
        </form>
    </div>
  </div>
